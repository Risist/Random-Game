...
#region Fate
	...
	[System.NonSerialized]
	public string[] possibleFateNames;
	...
	// lvl ups given fate. If fate has max lvl returns false instead; Returns false in case if fate is invalid or not choosen as a path
...
#region Skills
	...
	{
		if (IsUnlocked(weapon) || !weapon.MeetsRequirements())
